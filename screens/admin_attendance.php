...
<body style="font-family: 'Sen', sans-serif;">
        ...
        <nav class="bg-white p-4 shadow-md">
            <div class="flex justify-between items-center my-0 mx-auto" style="max-width: 1424px;">
                ...
                <div class="flex items-center">
                    <img src="../public/icons/user.png" id="admin_profile" class="w-8 h-8 cursor-pointer rounded-full" alt="user">
                    <a href="../index.php" class="ml-4 block bg-red-400 text-white py-1 px-4 rounded" id="logout">Logout</a>
                </div>
            </div>
        </nav>

        <div id="admin_profile_box" ></div>
        ...
        <div class="max-w-screen-xl my-0 mx-auto px-4 ">
            ...
            <div class="border-gray-200 mb-10">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                    <li class="mr-2">
                        <a href="./admin_dashboard.php" class="inline-flex p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300">Students
                        </a>
                    </li>
                    <li class="mr-2">
                        <a href="#" class="inline-flex p-4  rounded-t-lg border-b-2  text-blue-600 border-blue-600 ">Attendance</a>
                    </li>
                    <li class="mr-2">
                        <a href="./admin_attendance_report.php" class="inline-flex p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 group">Attendance Report
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="mb-7">
                <form action="" id="form1" method="post" accept-charset="utf-8" >
                    ...
                    <div class="flex">
                        ...
                        <button type="submit" class="bg-black py-2 px-4 text-white rounded w-fit h-fit">search</button>
                    </div>
                </form>
            </div>
            ...
            <div id="class_attendance">
                <div  class="overflow-x-auto overflow-y-auto relative shadow-md sm:rounded-lg " >
                    <table class="w-full text-sm text-left text-gray-700">
                        ...
                        <tbody id="tbody_attendance" ></tbody>
                    </table>
                </div>
            </div>
    ...
    <script>
        ...
        const admin_profile_box  = document.getElementById('admin_profile_box');

        admin_profile.addEventListener('click', () => {
            admin_profile_box.classList.add("active")
        })

        admin_profile_box.addEventListener('click', () => {
            admin_profile_box.classList.remove("active")
        })
        ...
        function getProfile(){
            ...
            if (id !== '') {
                ...
                xmlhttp.open("GET", "../controllers/admin_profile.php?id="+id, true);
                ...
                xmlhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        admin_profile_box.innerHTML = this.responseText;
                    }
                };
