        ...
        <div class="max-w-screen-xl my-0 mx-auto px-4 ">
            ...
            <div class="border-gray-200 mb-10">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                    ...
                    <li class="mr-2">
                        <a href="./admin_attendance.php" class="inline-flex p-4  rounded-t-lg border-b-2  border-transparent hover:text-gray-600 hover:border-gray-300 group ">Attendance</a>
                    </li>
                    <li class="mr-2">
